    ...
    <section ref={sectionRef} className="h-screen w-full overflow-hidden">
      ...
      >
        {slides.map((slide, i) => (
          <div
            key={i}
            className="w-screen flex items-center flex-col-reverse md:flex-row justify-around p-10"
          >
            ...
            <div className="w-50 h-50 md:w-80 md:h-80 rounded-full overflow-hidden">
              <img
                src={slide.img}
                alt={slide.title}
