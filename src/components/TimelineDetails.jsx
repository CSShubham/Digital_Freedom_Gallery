...
function TimelineDetails() {
  ...
  return (
    <div className="w-full min-h-screen p-4 md:p-6 flex flex-col items-center">
      ...
      <div className="md:w-[150vh] space-y-6">
        {year.events.map((event, idx) => (
          <div key={idx} className={`flex flex-col-reverse md:flex-row items-center md:items-start gap-4 ${
            idx % 2 === 1 ? 'flex-col-reverse md:flex-row-reverse' : ''
          }`}>
            {/* Content */}
            <div className="flex-1 text-center md:text-start py-8 px-4">
